...
class themerex_widget_popular_posts extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'themerex_widget_popular_posts', esc_html__('ThemeREX - Most Popular & Commented Posts', 'trx_utils'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		if (count($tabs) > 0) {
			...
			themerex_show_layout(themerex_do_shortcode('[trx_tabs style="2"]'.join($tabs).'[/trx_tabs]'));
	...
	function form($instance) {
		...
		<p>
			...
			<input type="radio" id="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_2" name="<?php echo esc_attr($this->get_field_name('show_counters')); ?>" value="1" <?php echo balanceTags($show_counters==1 ? ' checked="checked"' : ''); ?> />
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php esc_html_e('Show', 'trx_utils'); ?></label>
			<input type="radio" id="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_0" name="<?php echo esc_attr($this->get_field_name('show_counters')); ?>" value="0" <?php echo balanceTags($show_counters==0 ? ' checked="checked"' : ''); ?> />
