...
if ( !function_exists( 'themerex_sc_skills_reg_shortcodes' ) ) {
	...
	function themerex_sc_skills_reg_shortcodes() {
		...
		$THEMEREX_GLOBALS['shortcodes']["trx_skills"] = array(
			...
			"desc" => wp_kses( __("Insert skills diagramm in your page (post)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
			"decorate" => true,
			"container" => false,
			"params" => array(
				"max_value" => array(
					"title" => esc_html__("Max value", "trx_utils"),
					"desc" => wp_kses( __("Max value for skills items", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"value" => 100,
					"min" => 1,
					"type" => "spinner"
				),
				"type" => array(
					...
					"desc" => wp_kses( __("Select type of skills block", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"value" => "bar",
					"type" => "checklist",
					"dir" => "horizontal",
					"options" => array(
				...
				"layout" => array(
					...
					"desc" => wp_kses( __("Select layout of skills block", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"dependency" => array(
				...
				"dir" => array(
					...
					"desc" => wp_kses( __("Select direction of skills block", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"dependency" => array(
						'type' => array('counter','pie','bar')
					),
					"value" => "horizontal",
				...
				"style" => array(
					...
					"desc" => wp_kses( __("Select style of skills items (only for type=counter)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"dependency" => array(
						'type' => array('counter')
					),
					"value" => 1,
				...
				"color" => array(
					...
					"desc" => wp_kses( __("Color for all skills items", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"divider" => true,
					"value" => "",
					"type" => "color"
				),
				"bg_color" => array(
					...
					"desc" => wp_kses( __("Background color for all skills items (only for type=pie)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"dependency" => array(
						'type' => array('pie')
					),
					"value" => "",
				...
				"border_color" => array(
					...
					"desc" => wp_kses( __("Border color for all skills items (only for type=pie)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"dependency" => array(
						'type' => array('pie')
					),
					"value" => "",
				...
				"align" => array(
					...
					"desc" => wp_kses( __("Align skills block to left or right side", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"value" => "",
					"type" => "checklist",
					"dir" => "horizontal",
				...
				"arc_caption" => array(
					...
					"desc" => wp_kses( __("Arc caption - text in the center of the diagram", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"dependency" => array(
						'type' => array('arc')
					),
					"value" => "",
				...
				"pie_compact" => array(
					...
					"desc" => wp_kses( __("Show all skills in one diagram or as separate diagrams", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"dependency" => array(
						'type' => array('pie')
					),
					"value" => "yes",
				...
				"pie_cutout" => array(
					...
					"desc" => wp_kses( __("Pie cutout (0-99). 0 - without cutout, 99 - max cutout", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"dependency" => array(
						'type' => array('pie')
					),
					"value" => 0,
			...
			"children" => array(
				...
				"desc" => wp_kses( __("Skills item", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
				"container" => false,
				"params" => array(
					"title" => array(
						"title" => esc_html__("Title", "trx_utils"),
						"desc" => wp_kses( __("Current skills item title", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => "",
						"type" => "text"
					),
					"value" => array(
						"title" => esc_html__("Value", "trx_utils"),
						"desc" => wp_kses( __("Current skills level", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => 50,
						"min" => 0,
						"step" => 1,
						"type" => "spinner"
					...
					"color" => array(
						...
						"desc" => wp_kses( __("Current skills item color", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => "",
						"type" => "color"
					),
					"bg_color" => array(
						"title" => esc_html__("Background color", "trx_utils"),
						"desc" => wp_kses( __("Current skills item background color (only for type=pie)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => "",
						"type" => "color"
					),
					"border_color" => array(
						"title" => esc_html__("Border color", "trx_utils"),
						"desc" => wp_kses( __("Current skills item border color (only for type=pie)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => "",
						"type" => "color"
					),
					"style" => array(
						"title" => esc_html__("Counter style", "trx_utils"),
						"desc" => wp_kses( __("Select style for the current skills item (only for type=counter)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => 1,
						"options" => themerex_get_list_styles(1, 4),
						"type" => "checklist"
					), 
					"icon" => array(
						...
						"desc" => wp_kses( __('Select icon from Fontello icons set, placed above counter (only for type=counter)',  'trx_utils'), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => "",
						"type" => "icons",
...
if ( !function_exists( 'themerex_sc_skills_reg_shortcodes_vc' ) ) {
	...
	function themerex_sc_skills_reg_shortcodes_vc() {
		...
		vc_map( array(
			...
			"description" => wp_kses( __("Insert skills diagramm", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses( __("Max value for skills items", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => "100",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses( __("Select type of skills block", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => array(
				...
				array(
					...
					"description" => wp_kses( __("Select layout of skills block", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					'dependency' => array(
						'element' => 'type',
				...
				array(
					...
					"description" => wp_kses( __("Select direction of skills block", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					...
					"description" => wp_kses( __("Select style of skills items (only for type=counter)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					...
					"description" => wp_kses( __("Skills columns count (required)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses( __("Color for all skills items", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					...
					"description" => wp_kses( __("Background color for all skills items (only for type=pie)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('pie')
					),
				...
				array(
					...
					"description" => wp_kses( __("Border color for all skills items (only for type=pie)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('pie')
					),
				...
				array(
					...
					"description" => wp_kses( __("Align skills block to left or right side", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"class" => "",
				...
				array(
					...
					"description" => wp_kses( __("Arc caption - text in the center of the diagram", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('arc')
					),
				...
				array(
					...
					"description" => wp_kses( __("Show all skills in one diagram or as separate diagrams", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('pie')
					),
				...
				array(
					...
					"description" => wp_kses( __("Pie cutout (0-99). 0 - without cutout, 99 - max cutout", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					'dependency' => array(
						'element' => 'type',
						'value' => array('pie')
					),
		...
		vc_map( array(
			...
			"description" => wp_kses( __("Skills item", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
			"show_settings_on_create" => true,
			...
			"params" => array(
				array(
					"param_name" => "title",
					"heading" => esc_html__("Title", "trx_utils"),
					"description" => wp_kses( __("Title for the current skills item", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses( __("Value for the current skills item", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "color",
					"heading" => esc_html__("Color", "trx_utils"),
					"description" => wp_kses( __("Color for current skills item", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				...
				array(
					"param_name" => "bg_color",
					"heading" => esc_html__("Background color", "trx_utils"),
					"description" => wp_kses( __("Background color for current skills item (only for type=pie)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				...
				array(
					"param_name" => "border_color",
					"heading" => esc_html__("Border color", "trx_utils"),
					"description" => wp_kses( __("Border color for current skills item (only for type=pie)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"class" => "",
					"value" => "",
					"type" => "colorpicker"
				),
				array(
					...
					"description" => wp_kses( __("Select style for the current skills item (only for type=counter)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => array_flip(themerex_get_list_styles(1, 4)),
					"type" => "dropdown"
				...
				array(
					...
					"description" => wp_kses( __("Select icon from Fontello icons set, placed before counter (only for type=counter)", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"class" => "",
