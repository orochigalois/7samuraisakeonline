...
if ( !function_exists( 'themerex_sc_number_reg_shortcodes' ) ) {
	...
	function themerex_sc_number_reg_shortcodes() {
		...
		$THEMEREX_GLOBALS['shortcodes']["trx_number"] = array(
			...
			"desc" => wp_kses( __("Insert number or any word as set separate characters", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
			"decorate" => false,
			"container" => false,
			"params" => array(
				"value" => array(
					"title" => esc_html__("Value", "trx_utils"),
					"desc" => wp_kses( __("Number or any word", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"value" => "",
					"type" => "text"
				),
				"align" => array(
...
if ( !function_exists( 'themerex_sc_number_reg_shortcodes_vc' ) ) {
	...
	function themerex_sc_number_reg_shortcodes_vc() {
		...
		vc_map( array(
			...
			"description" => wp_kses( __("Insert number or any word as set of separated characters", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses( __("Number or any word to separate", "trx_utils"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
