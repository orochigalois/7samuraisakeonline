...
<div id="custom_options" class="custom_options <?php echo esc_attr($co_style); ?>">
	...
	<div class="co_header">
		<div class="co_title">
			<span><?php esc_html_e('Style switcher', 'wineshop'); ?></span>
			<a href="#" id="co_theme_reset" class="co_reset icon-retweet" title="<?php  esc_attr_e('Reset to defaults', 'wineshop'); ?>"><?php esc_html_e('RESET', 'wineshop'); ?></a>
		</div>
	</div>
		...
		<div class="sc_scroll_wrapper swiper-wrapper">
			<div class="sc_scroll_slide swiper-slide">
				...
				<div class="co_section">
					<div class="co_label"><?php esc_html_e('Body styles', 'wineshop'); ?></div>
					<div class="co_switch_box co_switch_horizontal co_switch_columns_2" data-options="body_style">
						...
						<a href="#" data-value="boxed"><?php esc_html_e('Boxed', 'wineshop'); ?></a>
						<a href="#" data-value="wide"><?php esc_html_e('Wide', 'wineshop'); ?></a>
					</div>
				</div>

				<div class="co_section">
					<div class="co_label"><?php esc_html_e('Color scheme', 'wineshop'); ?></div>
					<div id="co_scheme_list" class="co_image_check" data-options="body_scheme">
						...
						if (is_array($color_scheme_list) && count($color_scheme_list) > 0) {
							foreach ($color_scheme_list as $k=>$v) {
								...
								?>
								<a href="#" id="scheme_<?php echo esc_attr($k); ?>" class="co_scheme_wrapper<?php themerex_show_layout($color_scheme==$k ? ' active' : ''); ?>" style="background-image: url(<?php echo esc_url($scheme); ?>)" data-value="<?php echo esc_attr($k); ?>"><span><?php echo esc_attr($v); ?></span></a>
								<?php
							}
						}
						?>
				...
				<div class="co_section">
					<div class="co_label"><?php esc_html_e('Background pattern', 'wineshop'); ?></div>
				...
				<div class="co_section">
					<div class="co_label"><?php esc_html_e('Background image', 'wineshop'); ?></div>
