					<div class="logo">
						<a href="<?php echo esc_url(home_url('/')); ?>"><?php
							echo !empty($THEMEREX_GLOBALS['logo']) 
								? '<img src="'.esc_url($THEMEREX_GLOBALS['logo']).'" class="logo_main" alt="'.esc_attr__('Logo', 'wineshop').'">'
								: ''; 
							echo !empty($THEMEREX_GLOBALS['logo_fixed']) 
								? '<img src="'.esc_url($THEMEREX_GLOBALS['logo_fixed']).'" class="logo_fixed" alt="'.esc_attr__('Logo', 'wineshop').'">'
								: '';
