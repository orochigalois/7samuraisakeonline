...
if ( !function_exists( 'themerex_template_related_theme_setup' ) ) {
	...
	function themerex_template_related_theme_setup() {
		themerex_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'wineshop'),
		...
		themerex_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'wineshop'),
		...
		themerex_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'wineshop'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'wineshop'),
			'w'		 => 390,
			'h'		 => 390
		));
		themerex_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'wineshop'),
